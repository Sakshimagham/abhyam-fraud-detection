...
try:
    ...
    <style>
        ...
        * {
        ...
        /* Dark background for outer edges – optional, kept for consistency */
        body {
            background: #0A0C10;
    ...
    # ============================================
    # LANGUAGE‑SPECIFIC TEXTS (Punjabi)
    # ============================================
    TEXTS = {
        'app_subtitle': "ਭਾਰਤ ਦਾ ਪਹਿਲਾ ਬਹੁ-ਭਾਸ਼ਾਈ ਧੋਖਾਧੜੀ ਖੋਜ ਪ੍ਰਣਾਲੀ",
        'tagline': 'ਨਿਡਰ ਧੋਖਾਧੜੀ ਢਾਲ – ੧.੪ ਅਰਬ ਭਾਰਤੀਆਂ ਨੂੰ ਉਨ੍ਹਾਂ ਦੀ ਭਾਸ਼ਾ ਵਿੱਚ ਸੁਰੱਖਿਆ',
        'detector': '🔍 ਖੋਜਕਰਤਾ',
        'learn': '🎓 ਸਿੱਖੋ',
        'help': '🆘 ਮਦਦ',
        'stats': '📊 ਅੰਕੜੇ',
        'community': '👥 ਕਮਿਊਨਿਟੀ',
        'about': 'ℹ️ ਪ੍ਰੋਜੈਕਟ ਬਾਰੇ',
        'login': '🔐 ਲੌਗਿਨ / ਉਪਭੋਗਤਾ ਨਾਮ',
        'language': '🌐 ਭਾਸ਼ਾ',
        'fraud_type': '🎯 ਧੋਖਾਧੜੀ ਦੀ ਕਿਸਮ',
        'today_stats': "📊 ਅੱਜ ਦੇ ਅੰਕੜੇ",
        'scans_today': 'ਅੱਜ ਦੇ ਸਕੈਨ',
        'frauds_blocked': 'ਰੋਕੀਆਂ ਗਈਆਂ ਧੋਖਾਧੜੀਆਂ',
        ...
        'social': '👥 ਸੋਸ਼ਲ ਮੀਡੀਆ',
        'website': '🌐 ਵੈੱਬਸਾਈਟ',
        'enter_sms': '📝 ਐੱਸਐੱਮਐੱਸ/ਸੁਨੇਹਾ ਦਰਜ ਕਰੋ',
        'sender_id': '📱 ਭੇਜਣ ਵਾਲਾ ਆਈਡੀ (ਵਿਕਲਪਿਕ)',
        'high_risk': '🚨 ਉੱਚ ਜੋਖਮ ਲੱਭਿਆ!',
        'medium_risk': '⚠️ ਦਰਮਿਆਨਾ ਜੋਖਮ',
        'low_risk': '✅ ਘੱਟ ਜੋਖਮ',
        'risk_score': 'ਜੋਖਮ ਸਕੋਰ',
        'detailed_analysis': '🔍 ਵਿਸਤ੍ਰਿਤ ਵਿਸ਼ਲੇਸ਼ਣ',
        'helplines': '📞 ਹੈਲਪਲਾਈਨ',
        'share_alert': '📤 ਚੇਤਾਵਨੀ ਸਾਂਝੀ ਕਰੋ',
        'detected_language': '✅ ਖੋਜੀ ਗਈ ਭਾਸ਼ਾ',
        'confidence': 'ਭਰੋਸਾ',
        'footer_text': '🇮🇳 ਅਭੈ – ਭਾਰਤ ਨੂੰ ਧੋਖਾਧੜੀ ਤੋਂ ਬਚਾਉਂਦਾ ਹੈ | ੧੨ ਭਾਰਤੀ ਭਾਸ਼ਾਵਾਂ | ੨੪x੭ ਮੁਫਤ ਸੇਵਾ',
        'footer_helpline': '📞 ਰਾਸ਼ਟਰੀ ਸਾਈਬਰ ਕ੍ਰਾਈਮ ਹੈਲਪਲਾਈਨ: 1930 | 📧 report@cybercrime.gov.in',
        'footer_copyright': '© ੨੦੨੪ ਅਭੈ – ਐਮਐੱਸਸੀ ਡੇਟਾ ਸਾਇੰਸ & ਏਆਈ ਪ੍ਰੋਜੈਕਟ',
        'sms_placeholder': 'ਕੋਈ ਵੀ ਸ਼ੱਕੀ ਸੁਨੇਹਾ ਇੱਥੇ ਪੇਸਟ ਕਰੋ...',
        'new_post': '📝 ਨਵੀਂ ਪੋਸਟ',
        'author': 'ਲੇਖਕ',
        'title': 'ਸਿਰਲੇਖ',
        'content': 'ਸਮੱਗਰੀ',
    ...
    with st.sidebar:
        ...
        if not st.session_state.logged_in:
            if st.button("🔐  ਲੌਗਿਨ ਕਰੋ", use_container_width=True):
                st.query_params["lang"] = "ਪੰਜਾਬੀ"
                st.query_params["redirect"] = "pages/punjabi.py"
                st.switch_page("pages/login.py")
            st.info("ਧੋਖਾਧੜੀ ਖੋਜ ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਤੱਕ ਪਹੁੰਚ ਕਰਨ ਲਈ ਕਿਰਪਾ ਕਰਕੇ ਲੌਗਿਨ ਕਰੋ")
        else:
            st.success(f"✅  ਲੌਗਿਨ ਕੀਤਾ: **{st.session_state.username}**")
            if st.button("🚪 ਲੌਗਆਉਟ", use_container_width=True):
                st.session_state.logged_in = False
                st.session_state.username = ''
                st.rerun()
        st.markdown("---")
        ...
        # Set default selection to current language (Punjabi)
        default_index = list(languages.keys()).index('ਪੰਜਾਬੀ')
        selected_lang = st.selectbox("Select Language", list(languages.keys()), index=default_index)
        if selected_lang != "ਪੰਜਾਬੀ":
    ...
    <div class="title-wrapper">
        ...
        <div class="lang-letter lang2">ਅ</div>
        ...
        <div class="title-center">ਅਭੈ</div>
    </div>
    ...
    with tabs[0]:
        ...
        with col_input:
            ...
            st.markdown("### 📥 ਇਨਪੁੱਟ", unsafe_allow_html=True)
            
            method = st.radio("ਇਨਪੁੱਟ ਢੰਗ ਚੁਣੋ", ["ਟੈਕਸਟ", "ਤਸਵੀਰ", "ਈਮੇਲ"], horizontal=True)
            text_input = ""
            sender_id = ""
            
            if method == "ਟੈਕਸਟ":
                text_input = st.text_area(TEXTS['enter_sms'], height=150, placeholder=TEXTS['sms_placeholder'])
                sender_id = st.text_input(TEXTS['sender_id'], placeholder="ਜਿਵੇਂ, BANKALERT")
            elif method == "ਤਸਵੀਰ":
                st.markdown('<div style="border:2px dashed #18B7BE; border-radius:20px; padding:20px;">', unsafe_allow_html=True)
                uploaded = st.file_uploader("ਤਸਵੀਰ ਅਪਲੋਡ ਕਰੋ", type=['png','jpg','jpeg'], label_visibility="collapsed")
                st.markdown('</div>', unsafe_allow_html=True)
                if uploaded:
                    with st.spinner("ਟੈਕਸਟ ਕੱਢਿਆ ਜਾ ਰਿਹਾ ਹੈ..."):
                        progress_bar = st.progress(0)
                        for i in range(100):
                            time.sleep(0.01)
                            progress_bar.progress(i + 1)
                        text_input = extract_text_from_image(uploaded)
                        st.text_area("ਕੱਢਿਆ ਗਿਆ ਟੈਕਸਟ", text_input, height=150)
            else:  # ਈਮੇਲ
                text_input = st.text_area("ਈਮੇਲ ਦਾ ਟੈਕਸਟ", height=150)
                sender_id = st.text_input("ਭੇਜਣ ਵਾਲੇ ਦਾ ਈਮੇਲ", placeholder="bhejnewala@example.com")
            
            col_btn1, col_btn2 = st.columns(2)
            with col_btn1:
                if st.button("🔍 ਭਾਸ਼ਾ ਖੋਜੋ", use_container_width=True):
                    if text_input:
                        with st.spinner("ਭਾਸ਼ਾ ਖੋਜੀ ਜਾ ਰਹੀ ਹੈ..."):
                            progress_bar = st.progress(0)
                            for i in range(100):
                                time.sleep(0.01)
                                progress_bar.progress(i + 1)
            ...
            with col_btn2:
                if st.button("🚨 ਧੋਖਾਧੜੀ ਦੀ ਜਾਂਚ ਕਰੋ", type="primary", use_container_width=True):
                    if not text_input:
                        st.warning("ਕਿਰਪਾ ਕਰਕੇ ਕੁਝ ਟੈਕਸਟ ਦਰਜ ਕਰੋ.")
                    else:
                        with st.spinner("ਵਿਸ਼ਲੇਸ਼ਣ ਕੀਤਾ ਜਾ ਰਿਹਾ ਹੈ..."):
                            progress_bar = st.progress(0)
                            for i in range(100):
                                time.sleep(0.02)
                                progress_bar.progress(i + 1)
        ...
        with col_output:
            if st.session_state.results:
                ...
                if companies:
                    st.markdown("### 🏢 ਕੰਪਨੀ ਪੜਤਾਲ")
                    for comp in companies:
                        st.markdown(f"**{comp['name']}**")
                        st.caption(f"ਅਧਿਕਾਰਤ ਡੋਮੇਨ: {comp['domain']}")
                        if res['sender']:
                            if verify_sender(comp['domain'], res['sender']):
                                st.success("✅ ਭੇਜਣ ਵਾਲੇ ਦਾ ਡੋਮੇਨ ਮੇਲ ਖਾਂਦਾ ਹੈ")
                            else:
                                st.warning("⚠️ ਭੇਜਣ ਵਾਲੇ ਦਾ ਡੋਮੇਨ ਮੇਲ ਨਹੀਂ ਖਾਂਦਾ")
                ...
                if st.session_state.username:
                    st.markdown(f"### {TEXTS['share_alert']} / ਫੀਡਬੈਕ")
                    ...
                    with col_f3:
                        if st.button("🔗 ਸਬੂਤ ਲਿੰਕ"):
                            st.session_state.show_proof = True
                    
                    if st.session_state.show_feedback:
                        comment = st.text_area("ਕੀ ਗਲਤ ਸੀ?")
                        if st.button("ਫੀਡਬੈਕ ਭੇਜੋ"):
                            save_feedback(res['text'], res['ml_prob'], res['rule_score'], result['final_score'], False, comment, "")
                            st.success("ਫੀਡਬੈਕ ਦਰਜ ਕੀਤਾ ਗਿਆ")
                            st.session_state.show_feedback = False
                    
                    if st.session_state.show_proof:
                        proof = st.text_input("ਅਧਿਕਾਰਤ ਲਿੰਕ ਪੇਸਟ ਕਰੋ")
                        if st.button("ਸਬੂਤ ਭੇਜੋ"):
                            save_feedback(res['text'], res['ml_prob'], res['rule_score'], result['final_score'], False, "", proof)
                            st.success("ਸਬੂਤ ਭੇਜਿਆ ਗਿਆ")
                            st.session_state.show_proof = False
                else:
                    st.info("ਫੀਡਬੈਕ ਦੇਣ ਲਈ ਕਿਰਪਾ ਕਰਕੇ ਲੌਗਿਨ ਕਰੋ।")
                
                share_text = f"ਮੈਂ ਇਸ ਸੁਨੇਹੇ ਨੂੰ ਅਭੈ ਨਾਲ ਚੈੱਕ ਕੀਤਾ। ਜੋਖਮ: {result['final_score']}% ({risk_level}). ਤੁਸੀਂ ਵੀ ਚੈੱਕ ਕਰੋ!"
                col_s1, col_s2, col_s3 = st.columns(3)
                with col_s1:
                    st.markdown(f"[![WhatsApp](https://img.icons8.com/color/48/000000/whatsapp--v1.png)]({get_whatsapp_link(share_text)})")
                with col_s2:
                    st.markdown(f"[![Email](https://img.icons8.com/color/48/000000/email.png)]({get_email_link('ਧੋਖਾਧੜੀ ਚੇਤਾਵਨੀ', share_text)})")
                with col_s3:
    ...
    with tabs[1]:
        ...
        st.write("ਧੋਖਾਧੜੀ ਬਾਰੇ ਸਿੱਖਿਆ ਸਮੱਗਰੀ ਇੱਥੇ ਸ਼ਾਮਲ ਕਰ ਸਕਦੇ ਹੋ – ਲੇਖ, ਵੀਡੀਓ ਆਦਿ।")
    ...
    with tabs[3]:
        ...
        with col_filter1:
            date_range = st.date_input("ਤਾਰੀਖ ਰੇਂਜ ਚੁਣੋ", [dates[0], dates[-1]])
        with col_filter2:
            fraud_types = st.multiselect("ਧੋਖਾਧੜੀ ਦੀ ਕਿਸਮ", df['Type'].unique(), default=df['Type'].unique())

        risk_threshold = st.slider("ਜੋਖਮ ਸੀਮਾ (%)", 0, 100, 50)

        filtered_df = df[(df['Date'] >= pd.Timestamp(date_range[0])) & 
                         (df['Date'] <= pd.Timestamp(date_range[1])) &
                         (df['Type'].isin(fraud_types))]

        fig = px.line(filtered_df, x='Date', y='Fraud Cases', title='ਰੋਜ਼ਾਨਾ ਧੋਖਾਧੜੀ ਦੇ ਕੇਸ',
        ...
        fig2 = px.bar(type_counts, x='Type', y='Fraud Cases', title='ਕਿਸਮ ਅਨੁਸਾਰ ਕੁੱਲ ਧੋਖਾਧੜੀ',
    ...
    with tabs[4]:
            ...
            for _, row in posts.sort_values('timestamp', ascending=False).iterrows():
                ...
                <div style="background:rgba(10,12,16,0.6); border-radius:24px; padding:1.5rem; margin-bottom:1rem; border:1px solid #2D3A46;">
                    ...
                    <div style="margin-top:0.8rem;">
                        <span style="color:#18B7BE;">ਸ਼੍ਰੇਣੀ: {row['category']}</span>
                        {f' <a href="{row["link"]}" target="_blank" style="color:#18B7BE;">🔗 ਲਿੰਕ</a>' if row['link'] else ''}
                    </div>
                </div>
                """, unsafe_allow_html=True)
        else:
            st.info("ਹਾਲੇ ਤੱਕ ਕੋਈ ਪੋਸਟ ਨਹੀਂ। ਪਹਿਲੀ ਪੋਸਟ ਬਣਾਓ!")
        ...
        if st.session_state.username:
            ...
            with st.form("new_post_form"):
                ...
                category = st.selectbox(TEXTS['category'], ["ਆਮ", "ਧੋਖਾਧੜੀ ਚੇਤਾਵਨੀ", "ਸਵਾਲ", "ਸਫਲਤਾ ਦੀ ਕਹਾਣੀ"])
                ...
                if submitted and title and content:
                    ...
                    st.success("ਪੋਸਟ ਜੋੜ ਦਿੱਤੀ ਗਈ!")
                    st.rerun()
        else:
            st.info("ਪੋਸਟ ਕਰਨ ਲਈ ਕਿਰਪਾ ਕਰਕੇ ਲੌਗਿਨ ਕਰੋ।")
    ...
    with tabs[5]:
        ...
        <div style="background:rgba(10,12,16,0.6); border-radius:32px; padding:2rem; border:1px solid #2D3A46;">
            <h3 style="color:#FEDD89;">ਅਭੈ – ਨਿਡਰ ਧੋਖਾਧੜੀ ਢਾਲ</h3>
            <p style="color:#EFF7F6;"><strong>ਅਭੈ ਕਿਉਂ?</strong> ਅਜਿਹੇ ਦੇਸ਼ ਵਿੱਚ ਜਿੱਥੇ ਲੱਖਾਂ ਲੋਕ ਆਪਣੀ ਮਾਤ ਭਾਸ਼ਾ ਵਿੱਚ ਧੋਖਾਧੜੀ ਦਾ ਸ਼ਿਕਾਰ ਹੁੰਦੇ ਹਨ, ਅਸੀਂ ਇੱਕ ਅਜਿਹਾ ਸਿਸਟਮ ਬਣਾਇਆ ਹੈ ਜੋ ਤੁਹਾਨੂੰ ਸਮਝਦਾ ਹੈ – ਭਾਵੇਂ ਤੁਸੀਂ ਹਿੰਦੀ, ਮਰਾਠੀ, ਤਮਿਲ ਜਾਂ ਭਾਰਤ ਦੀਆਂ ੧੨ ਅਧਿਕਾਰਤ ਭਾਸ਼ਾਵਾਂ ਵਿੱਚੋਂ ਕੋਈ ਵੀ ਬੋਲਦੇ ਹੋਵੋ। ਉੱਨਤ ਮਸ਼ੀਨ ਲਰਨਿੰਗ ਅਤੇ ਇੱਕ ਸ਼ਕਤੀਸ਼ਾਲੀ ਨਿਯਮ ਇੰਜਣ ਦੇ ਸੁਮੇਲ ਨਾਲ, ਅਭੈ ੧.੪ ਅਰਬ ਭਾਰਤੀਆਂ ਨੂੰ ਧੋਖਾਧੜੀ ਤੋਂ ਬਚਾਉਂਦਾ ਹੈ, ਇੱਕ ਸੁਨੇਹੇ ਵਿੱਚ।</p>
            <hr style="border-color:#2D3A46;">
            <p><strong style="color:#18B7BE;">👩‍💻 ਸਿਰਜਣਹਾਰ:</strong> <span style="color:#9BB8C9;">ਸਾਕਸ਼ੀ ਸ਼੍ਰੀਕ੍ਰਿਸ਼ਨ ਮਗਮ</span></p>
            <p><strong style="color:#18B7BE;">🎓 ਪੜ੍ਹਾਈ:</strong> <span style="color:#9BB8C9;">ਐਮਐੱਸਸੀ ਡੇਟਾ ਸਾਇੰਸ ਅਤੇ ਆਰਟੀਫਿਸ਼ੀਅਲ ਇੰਟੈਲੀਜੈਂਸ</span></p>
            <p><strong style="color:#18B7BE;">🏛️ ਸੰਸਥਾ:</strong> <span style="color:#9BB8C9;">ਰਾਮਨਿਰੰਜਨ ਝੁਨਝੁਨਵਾਲਾ ਕਾਲਜ</span></p>
            <p><strong style="color:#18B7BE;">🔧 ਤਕਨਾਲੋਜੀ:</strong> <span style="color:#9BB8C9;">Python, Scikit‑learn, XGBoost, Streamlit, ਕਸਟਮ ਨਿਯਮ ਇੰਜਣ, ਬਹੁ-ਭਾਸ਼ਾਈ NLP, OCR, ਅਤੇ ਹੋਰ ਬਹੁਤ ਕੁਝ।</span></p>
            <p><strong style="color:#18B7BE;">📧 ਸੰਪਰਕ:</strong> <span style="color:#9BB8C9;">sakshimagham@gmail.com</span></p>
            <p><strong style="color:#18B7BE;">🌟 ਦ੍ਰਿਸ਼ਟੀਕੋਣ:</strong> <span style="color:#9BB8C9;">ਹਰ ਨਾਗਰਿਕ ਨੂੰ ਰੀਅਲ-ਟਾਈਮ, ਭਾਸ਼ਾ-ਸੁਤੰਤਰ ਸੁਰੱਖਿਆ ਪ੍ਰਦਾਨ ਕਰਕੇ ਧੋਖਾਧੜੀ-ਮੁਕਤ ਡਿਜੀਟਲ ਭਾਰਤ ਬਣਾਉਣਾ।</span></p>
            <p><em style="color:#DD8EA4;">ਇਹ ਪ੍ਰੋਜੈਕਟ ਐਮਐੱਸਸੀ ਡੇਟਾ ਸਾਇੰਸ & ਏਆਈ ਕੋਰਸ ਦੀ ਅੰਤਿਮ ਸਾਲ ਦੀ ਲੋੜ ਵਜੋਂ ਪੇਸ਼ ਕੀਤਾ ਗਿਆ ਹੈ। ਅਸੀਂ ਉਮੀਦ ਕਰਦੇ ਹਾਂ ਕਿ ਇਹ ਇੱਕ ਫਰਕ ਲਿਆਵੇਗਾ।</em></p>
        </div>
        """, unsafe_allow_html=True)
