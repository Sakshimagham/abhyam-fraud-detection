...
try:
    ...
    # ============================================
    # TAB 1: DETECTOR (updated logic: 90% rule, 10% ML)
    # ============================================
    with tabs[0]:
                    ...
                    if text_input:
                        with st.spinner("ভাষা শনাক্ত করা হচ্ছে..."):
                            ...
                            for i in range(100):
                                time.sleep(0.01)
                                progress_bar.progress(i + 1)
                            # Use rule engine's language detection for consistency (gives code-mixed flag)
    ...
    with tabs[5]:
        ...
        <div style="background:rgba(10,12,16,0.6); border-radius:32px; padding:2rem; border:1px solid #2D3A46;">
            ...
            <p><strong style="color:#18B7BE;">🌟 লক্ষ্য:</strong> <span style="color:#9BB8C9;">প্রত্যেক নাগরিককে রিয়েল-টাইম, ভাষা-স্বাধীন সুরক্ষা প্রদর্শন করে জালিয়াতি-মুক্ত ডিজিটাল ভারত তৈরি করা।</span></p>
