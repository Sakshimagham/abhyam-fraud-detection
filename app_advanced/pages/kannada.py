...
try:
    ...
    # ============================================
    # LANGUAGE‑SPECIFIC TEXTS (Kannada)
    # ============================================
    TEXTS = {
        'app_subtitle': "ಭಾರತದ ಮೊದಲ ಬಹುಭಾಷಾ ವಂಚನೆ ಪತ್ತೆ ವ್ಯವಸ್ಥೆ",
        'tagline': 'ನಿರ್ಭಯ ಮೋಸದ ಗುರಾಣಿ – 1.4 ಬಿಲಿಯನ್ ಭಾರತೀಯರನ್ನು ಅವರ ಭಾಷೆಯಲ್ಲಿ ರಕ್ಷಿಸುವುದು',
        'detector': '🔍 ಪತ್ತೆಕಾರಕ',
        'learn': '🎓 ಕಲಿಯಿರಿ',
        'help': '🆘 ಸಹಾಯ',
        'stats': '📊 ಅಂಕಿಅಂಶಗಳು',
        'community': '👥 ಸಮುದಾಯ',
        'about': 'ℹ️ ಯೋಜನೆಯ ಬಗ್ಗೆ',
        'login': '🔐 ಲಾಗಿನ್ / ಬಳಕೆದಾರ ಹೆಸರು',
        'language': '🌐 ಭಾಷೆ',
        'fraud_type': '🎯 ವಂಚನೆಯ ಪ್ರಕಾರ',
        'today_stats': "📊 ಇಂದಿನ ಅಂಕಿಅಂಶಗಳು",
        'scans_today': 'ಇಂದಿನ ಸ್ಕ್ಯಾನ್‌ಗಳು',
        'frauds_blocked': 'ತಡೆಹಿಡಿಯಲಾದ ವಂಚನೆಗಳು',
        ...
        'website': '🌐 ವೆಬ್‌ಸೈಟ್',
        'enter_sms': '📝 SMS/ಸಂದೇಶವನ್ನು ನಮೂದಿಸಿ',
        'sender_id': '📱 ಕಳುಹಿಸಿದವರ ID (ಐಚ್ಛಿಕ)',
        'high_risk': '🚨 ಹೆಚ್ಚಿನ ಅಪಾಯ ಪತ್ತೆಯಾಗಿದೆ!',
        'medium_risk': '⚠️ ಮಧ್ಯಮ ಅಪಾಯ',
        'low_risk': '✅ ಕಡಿಮೆ ಅಪಾಯ',
        'risk_score': 'ಅಪಾಯದ ಸ್ಕೋರ್',
        'detailed_analysis': '🔍 ವಿವರವಾದ ವಿಶ್ಲೇಷಣೆ',
        'helplines': '📞 ಸಹಾಯವಾಣಿಗಳು',
        'share_alert': '📤 ಎಚ್ಚರಿಕೆಯನ್ನು ಹಂಚಿಕೊಳ್ಳಿ',
        'detected_language': '✅ ಪತ್ತೆಯಾದ ಭಾಷೆ',
        'confidence': 'ವಿಶ್ವಾಸ',
        'footer_text': '🇮🇳 ಅಭಯಂ – ಭಾರತವನ್ನು ವಂಚನೆಯಿಂದ ರಕ್ಷಿಸುತ್ತದೆ | 12 ಭಾರತೀಯ ಭಾಷೆಗಳು | 24x7 ಉಚಿತ ಸೇವೆ',
        'footer_helpline': '📞 ರಾಷ್ಟ್ರೀಯ ಸೈಬರ್ ಕ್ರೈಂ ಸಹಾಯವಾಣಿ: 1930 | 📧 report@cybercrime.gov.in',
        'footer_copyright': '© 2024 ಅಭಯಂ – MSc ಡೇಟಾ ಸೈನ್ಸ್ & AI ಯೋಜನೆ',
        'sms_placeholder': 'ಯಾವುದೇ ಅನುಮಾನಾಸ್ಪದ ಸಂದೇಶವನ್ನು ಇಲ್ಲಿ ಅಂಟಿಸಿ...',
        'new_post': '📝 ಹೊಸ ಪೋಸ್ಟ್',
        'author': 'ಲೇಖಕ',
        'title': 'ಶೀರ್ಷಿಕೆ',
        'content': 'ವಿಷಯ',
    ...
    with st.sidebar:
        ...
        if not st.session_state.logged_in:
            if st.button("🔐 ಲಾಗಿನ್ ಮಾಡಿ", use_container_width=True):
                st.query_params["lang"] = "ಕನ್ನಡ"
                st.query_params["redirect"] = "pages/kannada.py"
                st.switch_page("pages/login.py")
            st.info("ವಂಚನೆ ಪತ್ತೆ ವೈಶಿಷ್ಟ್ಯಗಳನ್ನು ಪ್ರವೇಶಿಸಲು ದಯವಿಟ್ಟು ಲಾಗಿನ್ ಮಾಡಿ")
        else:
            st.success(f"✅ ಲಾಗಿನ್ ಆಗಿದ್ದಾರೆ: **{st.session_state.username}**")
            if st.button("🚪 ಲಾಗೌಟ್", use_container_width=True):
                st.session_state.logged_in = False
                st.session_state.username = ''
                st.rerun()
        st.markdown("---")
        ...
        # Set default selection to current language (Kannada)
        default_index = list(languages.keys()).index('ಕನ್ನಡ')
        selected_lang = st.selectbox("Select Language", list(languages.keys()), index=default_index)
        if selected_lang != "ಕನ್ನಡ":
    ...
    <div class="title-wrapper">
        ...
        <div class="title-center">ಅಭಯಂ</div>
    </div>
    ...
    with tabs[0]:
        ...
        with col_input:
            ...
            st.markdown("### 📥 ಇನ್ಪುಟ್", unsafe_allow_html=True)
            
            method = st.radio("ಇನ್ಪುಟ್ ವಿಧಾನವನ್ನು ಆಯ್ಕೆಮಾಡಿ", ["ಪಠ್ಯ", "ಚಿತ್ರ", "ಇಮೇಲ್"], horizontal=True)
            text_input = ""
            sender_id = ""
            
            if method == "ಪಠ್ಯ":
                text_input = st.text_area(TEXTS['enter_sms'], height=150, placeholder=TEXTS['sms_placeholder'])
                sender_id = st.text_input(TEXTS['sender_id'], placeholder="ಉದಾ, BANKALERT")
            elif method == "ಚಿತ್ರ":
                st.markdown('<div style="border:2px dashed #18B7BE; border-radius:20px; padding:20px;">', unsafe_allow_html=True)
                uploaded = st.file_uploader("ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ", type=['png','jpg','jpeg'], label_visibility="collapsed")
                st.markdown('</div>', unsafe_allow_html=True)
                if uploaded:
                    with st.spinner("ಪಠ್ಯವನ್ನು ಹೊರತೆಗೆಯಲಾಗುತ್ತಿದೆ..."):
                        progress_bar = st.progress(0)
                        for i in range(100):
                            time.sleep(0.01)
                            progress_bar.progress(i + 1)
                        text_input = extract_text_from_image(uploaded)
                        st.text_area("ಹೊರತೆಗೆಯಲಾದ ಪಠ್ಯ", text_input, height=150)
            else:  # ಇಮೇಲ್
                text_input = st.text_area("ಇಮೇಲ್ ನ ಪಠ್ಯ", height=150)
                sender_id = st.text_input("ಕಳುಹಿಸಿದವರ ಇಮೇಲ್", placeholder="kaluhisidavaru@example.com")
            
            col_btn1, col_btn2 = st.columns(2)
            with col_btn1:
                if st.button("🔍 ಭಾಷೆಯನ್ನು ಪತ್ತೆ ಮಾಡಿ", use_container_width=True):
                    if text_input:
                        with st.spinner("ಭಾಷೆಯನ್ನು ಪತ್ತೆ ಮಾಡಲಾಗುತ್ತಿದೆ..."):
                            progress_bar = st.progress(0)
                            for i in range(100):
                                time.sleep(0.01)
                                progress_bar.progress(i + 1)
            ...
            with col_btn2:
                if st.button("🚨 ವಂಚನೆ ಪರಿಶೀಲಿಸಿ", type="primary", use_container_width=True):
                    if not text_input:
                        st.warning("ದಯವಿಟ್ಟು ಸ್ವಲ್ಪ ಪಠ್ಯವನ್ನು ನಮೂದಿಸಿ.")
                    else:
                        with st.spinner("ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ..."):
                            ...
                            try:
                                ...
                                ml_prob = 0.5
                                model_source = "ನಿಯಮ ಎಂಜಿನ್ ಮಾತ್ರ"
        ...
        with col_output:
            if st.session_state.results:
                ...
                if companies:
                    st.markdown("### 🏢 ಕಂಪನಿ ಪರಿಶೀಲನೆ")
                    for comp in companies:
                        st.markdown(f"**{comp['name']}**")
                        st.caption(f"ಅಧಿಕೃತ ಡೊಮೇನ್: {comp['domain']}")
                        if res['sender']:
                            if verify_sender(comp['domain'], res['sender']):
                                st.success("✅ ಕಳುಹಿಸಿದವರ ಡೊಮೇನ್ ಹೊಂದಾಣಿಕೆಯಾಗಿದೆ")
                            else:
                                st.warning("⚠️ ಕಳುಹಿಸಿದವರ ಡೊಮೇನ್ ಹೊಂದಾಣಿಕೆಯಾಗುತ್ತಿಲ್ಲ")
                ...
                if st.session_state.username:
                    st.markdown(f"### {TEXTS['share_alert']} / ಪ್ರತಿಕ್ರಿಯೆ")
                    col_f1, col_f2, col_f3 = st.columns(3)
                    with col_f1:
                        if st.button("👍 ಹೌದು"):
                            save_feedback(res['text'], res['ml_prob'], res['rule_score'], result['final_score'], True, "", "")
                            st.success("ಧನ್ಯವಾದಗಳು!")
                    with col_f2:
                        if st.button("👎 ಇಲ್ಲ"):
                            st.session_state.show_feedback = True
                    with col_f3:
                        if st.button("🔗 ಪುರಾವೆ ಲಿಂಕ್"):
                            st.session_state.show_proof = True
                    
                    if st.session_state.show_feedback:
                        comment = st.text_area("ಏನು ತಪ್ಪಾಗಿತ್ತು?")
                        if st.button("ಪ್ರತಿಕ್ರಿಯೆ ಸಲ್ಲಿಸಿ"):
                            save_feedback(res['text'], res['ml_prob'], res['rule_score'], result['final_score'], False, comment, "")
                            st.success("ಪ್ರತಿಕ್ರಿಯೆ ದಾಖಲಿಸಲಾಗಿದೆ")
                            st.session_state.show_feedback = False
                    
                    if st.session_state.show_proof:
                        proof = st.text_input("ಅಧಿಕೃತ ಲಿಂಕ್ ಅನ್ನು ಅಂಟಿಸಿ")
                        if st.button("ಪುರಾವೆ ಸಲ್ಲಿಸಿ"):
                            save_feedback(res['text'], res['ml_prob'], res['rule_score'], result['final_score'], False, "", proof)
                            st.success("ಪುರಾವೆ ಸಲ್ಲಿಸಲಾಗಿದೆ")
                            st.session_state.show_proof = False
                else:
                    st.info("ಪ್ರತಿಕ್ರಿಯೆ ನೀಡಲು ದಯವಿಟ್ಟು ಲಾಗಿನ್ ಮಾಡಿ.")
                
                share_text = f"ನಾನು ಈ ಸಂದೇಶವನ್ನು ಅಭಯಂ ನೊಂದಿಗೆ ಪರಿಶೀಲಿಸಿದೆ. ಅಪಾಯ: {result['final_score']}% ({risk_level}). ನೀವೂ ಸಹ ಪರಿಶೀಲಿಸಿ!"
                col_s1, col_s2, col_s3 = st.columns(3)
                with col_s1:
                    st.markdown(f"[![WhatsApp](https://img.icons8.com/color/48/000000/whatsapp--v1.png)]({get_whatsapp_link(share_text)})")
                with col_s2:
                    st.markdown(f"[![Email](https://img.icons8.com/color/48/000000/email.png)]({get_email_link('ವಂಚನೆ ಎಚ್ಚರಿಕೆ', share_text)})")
                with col_s3:
    ...
    with tabs[1]:
        ...
        st.write("ವಂಚನೆಗಳ ಬಗ್ಗೆ ಶೈಕ್ಷಣಿಕ ವಿಷಯವನ್ನು ಇಲ್ಲಿ ಸೇರಿಸಬಹುದು – ಲೇಖನಗಳು, ವೀಡಿಯೊಗಳು ಇತ್ಯಾದಿ.")
    ...
    with tabs[3]:
        ...
        with col_filter1:
            date_range = st.date_input("ದಿನಾಂಕ ವ್ಯಾಪ್ತಿಯನ್ನು ಆಯ್ಕೆಮಾಡಿ", [dates[0], dates[-1]])
        with col_filter2:
            fraud_types = st.multiselect("ವಂಚನೆಯ ಪ್ರಕಾರ", df['Type'].unique(), default=df['Type'].unique())

        risk_threshold = st.slider("ಅಪಾಯದ ಮಿತಿ (%)", 0, 100, 50)

        filtered_df = df[(df['Date'] >= pd.Timestamp(date_range[0])) & 
                         (df['Date'] <= pd.Timestamp(date_range[1])) &
                         (df['Type'].isin(fraud_types))]

        fig = px.line(filtered_df, x='Date', y='Fraud Cases', title='ದೈನಂದಿನ ವಂಚನೆ ಘಟನೆಗಳು',
        ...
        fig2 = px.bar(type_counts, x='Type', y='Fraud Cases', title='ಪ್ರಕಾರದ ಪ್ರಕಾರ ಒಟ್ಟು ವಂಚನೆ',
    ...
    with tabs[4]:
            ...
            for _, row in posts.sort_values('timestamp', ascending=False).iterrows():
                ...
                <div style="background:rgba(10,12,16,0.6); border-radius:24px; padding:1.5rem; margin-bottom:1rem; border:1px solid #2D3A46;">
                    ...
                    <div style="margin-top:0.8rem;">
                        <span style="color:#18B7BE;">ವರ್ಗ: {row['category']}</span>
                        {f' <a href="{row["link"]}" target="_blank" style="color:#18B7BE;">🔗 ಲಿಂಕ್</a>' if row['link'] else ''}
                    </div>
                </div>
                """, unsafe_allow_html=True)
        else:
            st.info("ಇನ್ನೂ ಯಾವುದೇ ಪೋಸ್ಟ್‌ಗಳಿಲ್ಲ. ಮೊದಲ ಪೋಸ್ಟ್ ಅನ್ನು ರಚಿಸಿ!")
        ...
        if st.session_state.username:
            ...
            with st.form("new_post_form"):
                ...
                category = st.selectbox(TEXTS['category'], ["ಸಾಮಾನ್ಯ", "ವಂಚನೆ ಎಚ್ಚರಿಕೆ", "ಪ್ರಶ್ನೆ", "ಯಶೋಗಾಥೆ"])
                ...
                if submitted and title and content:
                    ...
                    st.success("ಪೋಸ್ಟ್ ಸೇರಿಸಲಾಗಿದೆ!")
                    st.rerun()
        else:
            st.info("ಪೋಸ್ಟ್ ಮಾಡಲು ದಯವಿಟ್ಟು ಲಾಗಿನ್ ಮಾಡಿ.")
    ...
    with tabs[5]:
        ...
        <div style="background:rgba(10,12,16,0.6); border-radius:32px; padding:2rem; border:1px solid #2D3A46;">
            <h3 style="color:#FEDD89;">ಅಭಯಂ – ನಿರ್ಭಯ ಮೋಸದ ಗುರಾಣಿ</h3>
            <p style="color:#EFF7F6;"><strong>ಅಭಯಂ ಏಕೆ?</strong> ಲಕ್ಷಾಂತರ ಜನರು ತಮ್ಮ ಮಾತೃಭಾಷೆಯಲ್ಲಿ ವಂಚನೆಗಳಿಗೆ ಒಳಗಾಗುವ ದೇಶದಲ್ಲಿ, ನಾವು ನಿಮ್ಮನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ ಒಂದು ವ್ಯವಸ್ಥೆಯನ್ನು ನಿರ್ಮಿಸಿದ್ದೇವೆ – ನೀವು ಹಿಂದಿ, ಮರಾಠಿ, ತಮಿಳು ಅಥವಾ ಭಾರತದ 12 ಅಧಿಕೃತ ಭಾಷೆಗಳಲ್ಲಿ ಯಾವುದನ್ನೇ ಮಾತನಾಡಿದರೂ. ಸುಧಾರಿತ ಯಂತ್ರ ಕಲಿಕೆ ಮತ್ತು ಪ್ರಬಲ ನಿಯಮ ಎಂಜಿನ್ ಅನ್ನು ಸಂಯೋಜಿಸುವ ಮೂಲಕ, ಅಭಯಂ 1.4 ಬಿಲಿಯನ್ ಭಾರತೀಯರನ್ನು ವಂಚನೆಯಿಂದ ರಕ್ಷಿಸುತ್ತದೆ, ಒಂದು ಸಂದೇಶದಲ್ಲಿ.</p>
            <hr style="border-color:#2D3A46;">
            <p><strong style="color:#18B7BE;">👩‍💻 ಸೃಷ್ಟಿಕರ್ತ:</strong> <span style="color:#9BB8C9;">ಸಾಕ್ಷಿ ಶ್ರೀಕೃಷ್ಣ ಮಗಂ</span></p>
            <p><strong style="color:#18B7BE;">🎓 ಓದುತ್ತಿರುವುದು:</strong> <span style="color:#9BB8C9;">MSc ಡೇಟಾ ಸೈನ್ಸ್ ಮತ್ತು ಕೃತಕ ಬುದ್ಧಿಮತ್ತೆ</span></p>
            <p><strong style="color:#18B7BE;">🏛️ ಸಂಸ್ಥೆ:</strong> <span style="color:#9BB8C9;">ರಾಮ್‌ನಿರಂಜನ್ ಝುಂಝುನ್‌ವಾಲಾ ಕಾಲೇಜು</span></p>
            <p><strong style="color:#18B7BE;">🔧 ತಂತ್ರಜ್ಞಾನಗಳು:</strong> <span style="color:#9BB8C9;">Python, Scikit‑learn, XGBoost, Streamlit, ಕಸ್ಟಮ್ ರೂಲ್ ಎಂಜಿನ್, ಬಹುಭಾಷಾ NLP, OCR, ಮತ್ತು ಹೆಚ್ಚು.</span></p>
            <p><strong style="color:#18B7BE;">📧 ಸಂಪರ್ಕ:</strong> <span style="color:#9BB8C9;">sakshimagham@gmail.com</span></p>
            <p><strong style="color:#18B7BE;">🌟 ದೃಷ್ಟಿಕೋನ:</strong> <span style="color:#9BB8C9;">ಪ್ರತಿಯೊಬ್ಬ ನಾಗರಿಕರಿಗೆ ನೈಜ-ಸಮಯ, ಭಾಷೆ-ಸ್ವತಂತ್ರ ರಕ್ಷಣೆಯನ್ನು ಒದಗಿಸುವ ಮೂಲಕ ವಂಚನೆ-ಮುಕ್ತ ಡಿಜಿಟಲ್ ಭಾರತವನ್ನು ಸೃಷ್ಟಿಸುವುದು.</span></p>
            <p><em style="color:#DD8EA4;">ಈ ಯೋಜನೆಯನ್ನು MSc ಡೇಟಾ ಸೈನ್ಸ್ & AI ಕೋರ್ಸ್‌ನ ಅಂತಿಮ ವರ್ಷದ ಅಗತ್ಯವಾಗಿ ಸಲ್ಲಿಸಲಾಗಿದೆ. ಇದು ಒಂದು ಬದಲಾವಣೆಯನ್ನು ತರುತ್ತದೆ ಎಂದು ನಾವು ಭಾವಿಸುತ್ತೇವೆ.</em></p>
        </div>
        """, unsafe_allow_html=True)
